...
class StudentTestController extends Controller
{
	...
	public function actionCreate()
	{
	    ...
	    if(isset($_POST['StudentTest']))
	    {
	        ...
	        if($model->validate())
	        {
				...
				$this->redirect(array('view','student_id'=>$model->student_id, 'test_id'=>$model->test_id));
	        }
	    }
	...
	public function actionUpdate($student_id, $test_id)
	{
		...
		if(isset($_POST['StudentTest']))
		{
			...
			$this->redirect(array('view',
	                    'student_id'=>$model->student_id, 'test_id'=>$model->test_id));
		}
	...
	{
		$model=StudentTest::model()->findByPk(array('student_id'=>$student_id, 'test_id'=>$test_id));
		if($model==null)
