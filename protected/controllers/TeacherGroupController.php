...
class TeacherGroupController extends Controller
{
	...
	public function actionCreate()
	{
	    ...
	    if(isset($_POST['TeacherGroup']))
	    {
	        ...
	        if($model->validate())
	        {
				...
				$this->redirect(array('view','teacher_id'=>$model->teacher_id, 'group_id'=>$model->group_id));
	        }
	    }
	...
	public function actionUpdate($teacher_id, $group_id)
	{
		...
		if(isset($_POST['TeacherGroup']))
		{
			...
			$this->redirect(array('view',
	                    'teacher_id'=>$model->teacher_id, 'group_id'=>$model->group_id));
		}
	...
	{
		$model=TeacherGroup::model()->findByPk(array('teacher_id'=>$teacher_id, 'group_id'=>$group_id));
		if($model==null)
