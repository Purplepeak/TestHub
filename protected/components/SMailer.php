...
class SMailer extends CApplicationComponent
{
	...
	private function formatEmail($format)
	{
		...
		$patterns = array('/{EMAIL}/', '/{KEY}/', '/{SITEPATH}/', '/{NAME}/', '/{BASE_URL}/');
		$replacements = array($this->email, $this->key, Yii::app()->request->hostInfo, $this->user_name, Yii::app()->request->baseUrl);
	...
	public static function sendEmail()
	{
		...
		$message ->setFrom(array(Yii::app()->params['siteEmail']['email'] => $this->siteTitle));
