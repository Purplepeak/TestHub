...
<div class="confirm-note">
	<h2>Спасибо за регистрацию на нашем сайте, ваш аккаунт был успешно создан!</h2>
	<p>На электронный адрес указанный вами при регистрации (<span class="bold-text"><?= CHtml::encode($model->email)?></span>) была выслана инструкция по активации аккаунта.</p>
